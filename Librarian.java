...
public class Librarian extends Teacher{
     ...
     */
    public void move(Person stu){
        int randomNum = random.nextInt(map.get(stu.currentLocation.name).size()); 
        System.out.println(map.get(stu.currentLocation.name).get(randomNum));
    }
